...
export const MENU: MenuItem[] = [
  ...
  {
    id: 10,
    label: 'MENUITEMS.APPS.LIST.CASES',
    icon: 'ph-bag-simple',
    link: '/case',
  },
  {
    id: 11,
    label: 'MENUITEMS.APPS.LIST.DOCUMENTS',
    icon: 'ph-file',
    link: '/document',
  },
  {
    ...
    subItems: [
      {
        id: 13,
        label: 'MENUITEMS.CONTACTS.LIST.PEOPLEGROUPS',
        link: '/contacts/people-group',
        parentId: 12
      },
      {
        id: 14,
        label: 'MENUITEMS.CONTACTS.LIST.CONTACTS',
        link: '/contacts/manage-contacts',
        parentId: 12
      }
    ]
  },
  // {
  //   id: 15,
  //   label: 'MENUITEMS.APPS.LIST.TASKS',
  ...
  {
    id: 20,
    label: 'MENUITEMS.APPS.LIST.COURTS',
    icon: 'ph-scroll',
    link: '/court',
  },
  {
